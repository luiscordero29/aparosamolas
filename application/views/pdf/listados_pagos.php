...
$obj_pdf->Cell(0, 0, 'LISTADOS / IMPAGOS', 0, 1, 'C', 0, '', 0,  0, '', 0);
$obj_pdf->Ln(5);
...
$html = '
            <table border="1" cellpadding="0" cellspacing="0">
                ...
                $html .= '<td><b>DNI:</b> '.$r['dni'].'<br /><b>Primer Apellido:</b> '.$r['apellido_1'].'<br /><b>Segundo Apellido:</b> '.$r['apellido_2'].'<br /><b>Nombres:</b> '.$r['nombres'].'</td>
                    <td><b>DNI:</b> '.$r['tdni'].'<br /><b>Apellidos:</b> '.$r['tapellidos'].'<br /><b>Nombres:</b> '.$r['tnombres'].'<br /><b>Teléfono:</b> '.$r['telefono_movil'].'<br /><b>Email:</b> '.$r['email_principal'].'</td>
                    <td>';
                ...
                $html .= number_format($monto, 2, ',', '.').' EUR
